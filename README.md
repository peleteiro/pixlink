...
- **Telefone** — `11912345678`, `5511912345678` ou `+5511912345678`
...
`/11912345678/50` e `/+5511912345678/50,00?utm_source=x` contem como
...
| URL                                        | Resultado                              |
| ------------------------------------------ | -------------------------------------- |
| `/11912345678/50,00`                       | Pagina com QR Code de R$ 50,00         |
| `/11912345678/50`                          | Mesmo resultado (forma compacta)       |
| `/111.444.777-35/15`                       | QR Code para CPF, R$ 15,00             |
