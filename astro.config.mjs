...
export default defineConfig({
  output: "server",
  // imageService: "passthrough" desabilita o auto-binding de Cloudflare
  // Images (IMAGES). Nao usamos `<Image />` do Astro — QR Codes sao SVG
  // gerado por qrcode-svg e o PNG sai via @resvg/resvg-wasm.
  ...(isTest ? {} : { adapter: cloudflare({ imageService: "passthrough" }) }),
  compressHTML: true,
  integrations: [react()],
